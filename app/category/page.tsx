                        ...
                        <div className="home--desktop  ">
                            <div className="category-layout">
                                ...
                                <div className="card-container">
                                    ...
                                    <div className="card--header__content">
                                        {filteredData2?.data?.slice(0, 11).map((item, index) => (
                                            <CategoryCard key={index} avatar={item.avatar} name={item.author} time={formatDate(item.updated_at)} image={item.thumbnail} title={item.title} content={item.description} category={item.category?.name} official={item.official} link={`/blog/ ${filteredData1?.slug}/${item.slug}-${item.id}`} style={{ padding: '10px 0', borderTop: 'none' }} />
                                        ))}
                            ...
                            <div className="home--desktop__right">
                                ...
                                <div className="card-container">
                                    ...
                                    <div className="card--header__content">
                                        <HotTopic isTitled={false} hotTopic={filteredData1} />
