...
const HeaderDesktop = () => {
    const menu = [
        ...
        { title: "Badminton", href: "#" },
        { title: "Basketball", href: "#" },
        { title: "Volleyball", href: "#" },
    ...
    return (
        <div className="header-desktop">
            ...
            <div className="header-desktop__right">
                <a className="item bg-white" href="shop.webthethao.vn" target="_blank"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
